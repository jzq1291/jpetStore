...
<div id="Main">
  ...
  <div id="Sidebar">
    <div id="SidebarContent">
       <img src="<%=basePath%>/images/fish_icon.gif"/></br>
   		 </br>
        <img src="<%=basePath%>/images/dogs_icon.gif"/></br>
        </br>
        <img src="<%=basePath%>/images/cats_icon.gif"/></br>    
     	 </br>
        <img src="<%=basePath%>/images/reptiles_icon.gif"/></br>
   		</br> 
        <img src="<%=basePath%>/images/birds_icon.gif"/></br>
      	</br>
    </div>
  </div>
