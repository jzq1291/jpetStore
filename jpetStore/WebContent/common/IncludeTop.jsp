	...
	<div id="Header">
		...
		<div id="Menu">
			<div id="MenuContent">
				...
				<img align="middle" name="img_cart"src="<%=basePath%>/images/cart.gif" /></a> 
		...
		<div id="QuickLinks">
			<a> <img src="<%=basePath%>/images/sm_fish.gif" /></a> 
			    <img src="<%=basePath%>/images/separator.gif" /> 
			<a> <img src="<%=basePath%>/images/sm_dogs.gif" /></a>
			    <img src="<%=basePath%>/images/separator.gif" /> 
			<a> <img src="<%=basePath%>/images/sm_reptiles.gif" /></a> 
				<img src="<%=basePath%>/images/separator.gif" />
			<a> <img src="<%=basePath%>/images/sm_cats.gif" /></a> 
				<img src="<%=basePath%>/images/separator.gif" /> 
			<a> <img src="<%=basePath%>/images/sm_birds.gif" /></a>
		</div>
